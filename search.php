  ...
  <section class="container-fluid">
  	<article class="row">
  		...
  		<div class="blog-header col-12 text-center" style="background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('<?php echo $header_bg_image['url']; ?>') no-repeat center center; background-size: cover;">
  			<h1 class="h1"><?php the_search_query(); ?></h1>
        ...
        <?php
      	...
      	<div class="col-12 col-md-8">
      		<h2 class="h1 text-center">
      			''<?php the_search_query(); ?>'' Search 404
      		</h2>
      		<p class="lead">
      			Sorry, but there doesn't appear to be any pages or posts on the topic of ''<?php the_search_query(); ?>''.
      		</p>
      		<p class="lead">
      			Try to broaden your search horizons or feel free to look through the categories and recent posts.
      		</p>
      		<p class="lead">
